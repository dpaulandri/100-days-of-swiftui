...
struct ContentView: View {
    ...
    var body: some View {
		...
		if viewModel.appUnlocked {
				...
				VStack {
					...
					HStack {
						...
						Button {
							...
							// DAY 73 - CHALLENGE #1 - MOVE ALL MODIFIERS TO THE IMAGE VIEW:
							/// MAKE THE ENTIRE BUTTON LABEL TAPPABLE, NOT JUST THE IMAGE VIEW
								.padding()
			...
			// ALERT WINDOW TO SHOW IF AUTHENTICATION FAILS
			.alert("Oops!", isPresented: $viewModel.authenticationFailed) {
