            ...
            List {
                ...
                Section("Business Expenses") {
                    ...
                    ForEach(businessExpenses.items) {item in
						...
						// DAY 76 - CHALLENGE #2
						/// READ OUR EXPENSE NAME & EXPENSE AMOUNT IN ONE SINGLE VOICE OVER LABEL
						/// EXPENSE TYPE AS THE HINT
						.accessibilityElement()
						.accessibilityLabel("\(item.expenseName) \(item.amount, format: .currency(code: Locale.current.currencyCode ?? "USD"))")
