...
//
// DAY 75 - ADDED ACCESSIBILITY LABELS FOR THE FLAG IMAGE
...
struct ContentView: View {
	...
	// PART OF DAY 75 - ACCESSIBILITY LABELS FOR FLAG IMAGE
	// ACCESSIBILITY LABEL DICTIONARY ARRAY
	/// DESCRIBING THE FLAGS W/O GIVING AWAY THE NAME OF THE COUNTRY
	let labels = [
                ...
                VStack(spacing: 15) {
                    ...
                    ForEach(0..<3) { number in
                        Button {
							...
							// PART OF DAY 75 - ACCESSIBILITY LABEL
							/// GET CORRESPONDING ACCESSIBILITY LABEL
							/// w/ DEFAULT VALUE TO FALL BACK ON
